...
<div class="panel panel-info panel-border top">
    ...
    <form class="form-horizontal" method="post" action="<?php echo base_url("pages/addformdb/" . $result->id); ?>"  id="frmAdd"  enctype="multipart/form-data">
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input class="form-control required" id="title" disabled value="<?php echo $result->title; ?>" required name="Page[title]"  placeholder="Title" type="text" />
                    <span id="errorTitle" style="color: red;"></span>
                    <br/>
                    <button class="btn btn-warning" id="titleChange">Change Title</button>
                </div>

                <label for="slug" class="col-sm-1 control-label"> Slug <span class="redstar">*</span></label>
                <div class="col-sm-2">
                    <input class="form-control required" id="slug" required name="Page[slug]"  value="<?php echo $result->slug; ?>" type="text" />
                    <span id="errorTitle" style="color: red;"></span>
                </div>
                ...
                <div class="col-md-12">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <textarea class="form-control summernote required" id="page_content_id" name="Page[content]" ><?php echo $result->content; ?></textarea>
                                </div>
                            </div>
