    ...
    <div class="tab-content center-block">
        <div class="admin-form" id="survey1" >
            <div class="panel panel-alert heading-border">
                ...
                <form method="post" action="<?php echo site_url('page/add_page'); ?>" id="frmAdd"  enctype="multipart/form-data">
                        ...
                        <div class="section row">
                            <div class="col-md-12">
                                <div class="section">
                                    ...
                                    <input type="text" name="Page[page_title]" id="name" class="gui-input" placeholder="Enter Title">
                                </div> 
                            </div>
                            <div class="col-md-12">
                                <div class="section">
                                    <label for="desc" class="field-label">Page Description</label>
                                    <textarea name="Page[description]" id="page_details" style="min-height: 350px;" class="gui-textarea"></textarea> 
                                </div> 
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="section">
                                    ...
                                    <input type="text" name="Page[sort_order]" id="sort_order" class="gui-input" value="1">
...
<div class="row">
    ...
    <div class="admin-form" id="top_header">
        <div class="panel panel-alert heading-border">
            <div class="panel-heading">
                <span class="panel-title"> Page  Listing </span>
                <span class="panel-title pull-right "><a href="" class="btn btn-primary" id="addPage"> <span class="fa fa-plus-square"></span>  Add New Page   </a></span>
            </div>
...
<script type="text/javascript">
    var current_url = '<?php echo site_url('page/page_listing') ?>';
    ...
    $(document).ready(function () {
        ...
        $("#addPage").die('click').live('click', function (e) {
            e.preventDefault();
            reset_form('frmAdd');
            $("#top_header").hide();
        ...
        $("#viewAllPage,.btnCancel").die('click').live('click', function (e) {
            e.preventDefault();
            load_data(current_url);
        });
