            ...
            <div class="row">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form-group text-center">
                                ...
                                <img src="<?php echo base_url('assets/site/images/' . $img); ?>" style="width: 100%;" />
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control" value="<?php echo $result->copyright_text; ?>" readonly type="text" />
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control" value="<?php echo $result->latest_video_link; ?>" readonly type="text" />
                                </div>
                            </div>
                ...
                <div class="col-md-6">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                <label for="sportsname" class="col-sm-3  control-label control-label_Post ">Selected Magazine</label>
                                <div class="col-sm-9">
                                    <input class="form-control" value="<?php echo $magazine->title; ?>" readonly type="text" />
                                </div>
                            </div>
                            <div class="form-group">
