        ...
        <div class="admin-form" id="survey1" >
            <div class="panel panel-alert heading-border">
                <div class="panel-heading">
                    ...
                    <span class="panel-title pull-right "><a href="" class="btn btn-primary" id="viewAllCategory"> <span class="fa fa-table"></span>  View All Category </a></span>
                </div>

                <form method="post" action="<?php echo site_url('category/add_category'); ?>" id="frmAdd"  enctype="multipart/form-data">
                        ...
                        <div class="section row">
                            <div class="col-md-12">
                                <div class="section">
                                    ...
                                    <input type="text" name="Category[name]" id="name" class="gui-input" placeholder="Enter name">
                                </div> 
                            </div>
                            <div class="col-md-12">
                                ...
                                <div class="section">
                                    ...
                                    <textarea name="Category[desc]" id="category_details" rows="60" class="gui-textarea"></textarea> 
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="section">
                                    ...
                                    <input type="text" name="Category[sort_order]" id="sort_order" class="gui-input" value="1">
...
<div class="row">
    ...
    <div class="admin-form" id="top_header">
        <div class="panel panel-alert heading-border">
            <div class="panel-heading">
                <span class="panel-title"> Category  Listing </span>
                <span class="panel-title pull-right "><a href="" class="btn btn-primary" id="addCategory"> <span class="fa fa-plus-square"></span>  Add New Category   </a></span>
            </div>
...
<script type="text/javascript">
    var current_url = '<?php echo site_url('category/category_listing') ?>';
    ...
    $(document).ready(function () {
        ...
        $("#addCategory").die('click').live('click', function (e) {
            e.preventDefault();
            reset_form('frmAdd');
            $("#top_header").hide();
        ...
        $("#viewAllCategory,.btnCancel").die('click').live('click', function (e) {
            e.preventDefault();
            load_data(current_url);
        });
